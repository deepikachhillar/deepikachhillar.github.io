...
---
<figure>
	<img style="display=inline-block" width="30%" src="{{ "/resources/images/courses/IMG_3911.png" |  prepend: site.baseurl }}" alt="Class Picture" />
</figure>
...
<figure>
	<img style="display=inline-block" width="60%" src="{{ "/resources/images/courses/IMG_3942.png" |  prepend: site.baseurl }}" alt="Class Picture" />
</figure>
